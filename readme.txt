...
List of external dependencies(located in src/lib):
1. gson-2.6.2.jar  - JsonPaymentParser class uses this library for parsing the payments.txt
2. hamcrest-core-1.3.jar - required for running JUNiT unit tests
    (http://central.maven.org/maven2/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar)
3. junit-4.12.jar - required for running JUNIT unit tests
...
6. src/graph - comprises of VenmoGraph which represents the graph built from the payments along with MedianFinder class to compute median.
